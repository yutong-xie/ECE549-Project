...
if __name__ == "__main__":
    if opt.preprocess:
        if opt.data_path.find('RainTrainH') != -1:
            ...
            prepare_data_Rain800(data_path=opt.data_path, patch_size=100, stride=100)
        elif opt.data_path.find('RainAtt') != -1:
            prepare_data_RainAtt(data_path=opt.data_path, patch_size=100, stride=100)
        else:
